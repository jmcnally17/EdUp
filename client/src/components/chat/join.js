    ...
    <section className="py-20 bg-white">
      <div className="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
        <div className="relative">
          <h2 className="w-full text-3xl font-bold text-center sm:text-4xl md:text-5xl">EdUp Chat Rooms</h2>
          {/* <p className="w-full py-8 mx-auto -mt-2 text-lg text-center text-gray-700 intro sm:max-w-3xl">Say goodbye to cash-stuffed envelopes and mysteriously vanishing school letters. Here you can pay for your child's tuition, sports clubs, activities and more!</p> */}
          <br></br>
          <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
              {/* <h3 className="mt-2 text-2xl sm:text-left md:text-4xl">Welcome</h3> */}
